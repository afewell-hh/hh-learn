...
async function createRedirect(fromPath, toPath, permanent, dryRun) {
...
async function main() {
    ...
    console.log(`🔐 Using HubSpot token: ${(0, get_hubspot_token_js_1.maskToken)(process.env.HUBSPOT_PROJECT_ACCESS_TOKEN || process.env.HUBSPOT_PRIVATE_APP_TOKEN || '')}`);
